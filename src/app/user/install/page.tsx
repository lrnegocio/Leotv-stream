    ...
    <div className="min-h-screen bg-background pb-20 p-6">
      <div className="max-w-4xl mx-auto space-y-8">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-3xl font-black uppercase font-headline italic text-primary">Central de Aplicativos v375-S</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <Card className="bg-card/50 border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl">
            ...
            <CardContent className="p-6 space-y-4">
              ...
              <div className="space-y-2">
                <Button className="w-full h-14 bg-primary font-black uppercase text-xs" onClick={() => window.open("https://web2apk.com/", "_blank")}>
                  <Download className="mr-2 h-4 w-4" /> Gerar APK via Web2APK
                </Button>
          ...
          <Card className="bg-orange-500/10 border-white/5 rounded-[2.5rem] overflow-hidden shadow-2xl p-8">
            <div className="flex flex-row items-center gap-4 mb-4">
              <div className="bg-orange-500 p-3 rounded-2xl"><Monitor className="h-6 w-6 text-white" /></div>
              <h3 className="text-sm font-black uppercase italic">Sistema Roku</h3>
            </div>
            <p className="text-[10px] font-bold opacity-60 uppercase italic mb-4">O Roku não aceita sites diretos. Use o método "Cast".</p>
